...
mod test_vector {
    ...
    use crate::constants::{Constants, Bls12381Const};
    use ark_bls12_381::{Bls12_381, G1Affine, G2Affine};
    use crate::utils::core_utilities::{mocked_calculate_random_scalars, hash_to_scalar};
    use crate::utils::interface_utilities::{HashToG1Bls12381, create_generators};
    ...
    fn test_hash_to_scalar_testvector() {
        ...
        assert_eq!(scalar_to_hex(scalar), "0f90cbee27beb214e6545becb8404640d3612da5d6758dffeccd77ed7169807c");    
    }
    ...
    fn test_mocked_calculate_random_scalars_testvector() {
        ...
        assert_eq!(scalar_to_hex(scalars[0]), "04f8e2518993c4383957ad14eb13a023c4ad0c67d01ec86eeb902e732ed6df3f");
        assert_eq!(scalar_to_hex(scalars[9]), "485e2adab17b76f5334c95bf36c03ccf91cef77dcfcdc6b8a69e2090b3156663");
    }
    ...
    fn test_msg_to_scalars_testvector() {
        ...
        assert_eq!(scalar_to_hex(msg_scalar), "1cb5bb86114b34dc438a911617655a1db595abafac92f47c5001799cf624b430");

        let msg = hex::decode("").unwrap();
        let msg_scalar: Fr = hash_to_scalar::<48, Fr>(&msg, &dst);
        assert_eq!(scalar_to_hex(msg_scalar), "08e3afeb2b4f2b5f907924ef42856616e6f2d5f1fb373736db1cca32707a7d16");
    }
    ...
    fn test_keygen_testvector() {
        ...
        assert_eq!(scalar_to_hex(sk.sk), "60e55110f76883a13d030b2f6bd11883422d5abde717569fc0731f51237169fc");
